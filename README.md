...
### v6.3.0 – DuckDuckGo Integration for Autonomous Web Monitoring
- ✅ Replaced OpenAI API dependency with DuckDuckGo API to eliminate paid dependency for web search (Principle 0: Agency)
- 🌐 Restored Tech Radar functionality without requiring OPENAI_API_KEY
- 🔍 Now capable of autonomous model tracking and pricing updates using free public API
- 💰 Budget-conscious operation: zero-cost web search enables continuous self-monitoring
